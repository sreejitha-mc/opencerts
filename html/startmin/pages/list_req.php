                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="temp_create.php?status=issue&id=<?php echo $id; ?>"><i class="fa fa-fw" aria-hidden="true" title="Copy to use check">&#xf00c</i></a>
                                                        <a href="cert_update_action.php?status=reject&id=<?php echo $id; ?>"><i class="fa fa-fw" aria-hidden="true" title="Copy to use close">&#xf00d</i></a>
                                                    </td>
                                                </tr>
                                                <?php
